...
export default function useChatBar(props) {
  ...
  const handleSave = async () => {
    try {
      ...
      const audioFile = await new File([audioBlob], "voice.wav", {
        type: "audio/wav",
      });
  ...
  return {
    ...
    chatbar: (
      <>
        <div className="w-full border-solid border-2 border-slate-100 rounded-full shadow-lg pr-8 pl-8 pt-6 pb-6 bg-white z-10">
